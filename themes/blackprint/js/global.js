...
function swapSearchFormContainer() {
    var menuSearchContainer = $('#adtm_menu li.advtm_search[data-js-swap-id="menu-search"]');
    var tabletSearchContainer = $('.tablet-container .advtm_search[data-js-swap-id="menu-search"]');
    var mobileSearchContainer = $('header .nav .advtm_search[data-js-swap-id="menu-search"]');
    var detachedSearch = false;

    if ($('.adtm_search_container').length) {
        if (window.innerWidth < 768) {
            if (!$('.adtm_search_container', mobileSearchContainer).length) {
                if ($('.adtm_search_container', tabletSearchContainer).length) {
                    detachedSearch = $('.adtm_search_container', tabletSearchContainer).detach();
                } else if ($('.adtm_search_container', menuSearchContainer).length) {
                    detachedSearch = $('.adtm_search_container', menuSearchContainer).detach();
                }
                if (detachedSearch) {
                    mobileSearchContainer.append(detachedSearch);
                }
            }
        } else if (window.innerWidth < 992) {
            if (!$('.adtm_search_container', tabletSearchContainer).length) {
                if ($('.adtm_search_container', mobileSearchContainer).length) {
                    detachedSearch = $('.adtm_search_container', mobileSearchContainer).detach();
                } else if ($('.adtm_search_container', menuSearchContainer).length) {
                    detachedSearch = $('.adtm_search_container', menuSearchContainer).detach();
                }
                if (detachedSearch) {
                    tabletSearchContainer.append(detachedSearch);
                }
            }
        } else if (!$('.adtm_search_container', menuSearchContainer).length) {
            if ($('.adtm_search_container', tabletSearchContainer).length) {
            ...
            if (detachedSearch) {
                menuSearchContainer.append(detachedSearch);
            }
        }
    }
}
...
function responsiveResize()
{
	...
	{
        $('.slideResponsive:not(.slick-initialized)').slick({
            centerMode: true,
            infinite: false,
            dots: true,
            arrows: false,
	...
	{
		$('.slideResponsive.slick-initialized').slick('unslick');
